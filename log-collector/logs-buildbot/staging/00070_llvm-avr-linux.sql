...
(70, 'null', ARRAY[2]::integer[], 'llvm-avr-linux', ARRAY['clang']::text[], 35427, 551734, true, 2, 1, 0, 42, '', '{}', to_timestamp(1615436130), to_timestamp(1615431710)), 
(70, 'null', ARRAY[2]::integer[], 'llvm-avr-linux', ARRAY['clang']::text[], 35465, 551859, true, 2, 2, 5, 42, '', '{}', to_timestamp(1615437534), to_timestamp(1615436129))
