...
(122, 'null', ARRAY[]::integer[], 'libcxx-libcxxabi-x86_64-linux-ubuntu-cxx11', ARRAY['libcxx']::text[], 42243, 639911, true, 2, 1, 0, 56, '', '{}', to_timestamp(1616450244), to_timestamp(1616449974), 'staging'), 
(122, 'null', ARRAY[]::integer[], 'libcxx-libcxxabi-x86_64-linux-ubuntu-cxx11', ARRAY['libcxx']::text[], 42250, 640485, true, 2, 2, 0, 56, '', '{}', to_timestamp(1616450286), to_timestamp(1616450243), 'staging'), 
(122, 'null', ARRAY[]::integer[], 'libcxx-libcxxabi-x86_64-linux-ubuntu-cxx11', ARRAY['libcxx']::text[], 42253, 640553, true, 2, 3, 5, 56, '', '{}', to_timestamp(1616450297), to_timestamp(1616450291), 'staging')
